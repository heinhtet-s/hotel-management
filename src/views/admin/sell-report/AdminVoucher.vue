    ...
    <div class="row">
      ...
      <div class="col-12 col-lg-10 mt-5">
        <!--        Product Select Modal
                <div class="modal" :class="showDialog?'show':''" ref="productSelectModal" style="z-index: 10000;" id="relationModal"  tabindex="-1" aria-labelledby="relationModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0" style="border-radius: var(&#45;&#45;border-radius);background-color: var(&#45;&#45;background-color);">
                      <div class="modal-header border-0">
                        <h5 class="modal-title align-items-center" id="relationModalLabel">
                          {{selectedProduct.itemName}} <span class="badge rounded-pill" style="background-color: var(&#45;&#45;light);color: var(&#45;&#45;text-color);">Stock : {{selectedProduct.stock}}</span></h5>
                        <button type="button" class="btn-close" @click="clearCart" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                       <div class="d-flex flex-column">
                         ...
                         <span class="badge mb-1" style="background-color: var(&#45;&#45;side-bar-bg);color: var(&#45;&#45;text-color);" v-if="selectedRelation!==''">1 {{selectedRelation[0].frontUnit}} ({{selectedRelations[0].backNumber}} Pcs) = {{parseInt(selectedRelation[0].sellPrice).toLocaleString()}} Ks</span>
                       </div>
                        <div class="d-flex">
                      ...
                      <div class="modal-footer border-0">
                        <button type="button" class="btn  " data-bs-dismiss="modal" style="background-color: var(&#45;&#45;light); color:var(&#45;&#45;text-color);">Cancel</button>
                        <button type="button" class="btn text-white" data-bs-dismiss="modal" @click="addToCart(selectedProduct);" style="background-color: var(&#45;&#45;primary);">Confirm</button>
                      </div>
                    </div>
                  </div>
                </div>-->
        ...
        <div class="row">
          <div class="bg-light" >
            <div class="d-flex justify-content-between border-0 align-items-center">
              <span class="fs-5 d-none d-lg-block">{{$t('message.sale_setup')}}</span>
              <!--                  Mobile elipsis-->
              <div class="dropdown d-lg-none">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <!--                      <li @click="addDiscountPrice"><a class="dropdown-item" href="#" ><i class="fas fa-tag"></i> Discount Price(Ks)</a></li>-->
                  <!--                      <li @click="addPromotion"><a class="dropdown-item" href="#" ><i class="fas fa-gift"></i> Promotion</a></li>-->
              ...
              <div class="d-flex">
                <div class="d-none d-lg-block">
                  <button class="btn" @click="printThis"><i class="fas fa-save"></i></button>
                  <button class="btn"  v-print="'#printcontent'"><i class="fas fa-print"></i></button>
                </div>
                <button type="button" class="btn" data-bs-dismiss="modal" @click="$router.back()" aria-label="Close"><i class="fas fa-times"></i></button>
              </div>
...
<!--                          <span class="w-25 text-end">{{((totalPrice*(parseInt(shopInfo.tax)/100)).toFixed(0)).toLocaleString()}} Ks</span>-->
            ...
            <div class="d-flex p-1 modal-footer align-items-center justify-center" style="z-index: 1000; background-color: var(--background-color);">
