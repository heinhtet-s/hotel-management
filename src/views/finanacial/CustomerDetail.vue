                  ...
                  <div class="text-center">
                    ...
                    <table class="table">
                      ...
                      <tr v-for="(name,index) in selectedInvoice.nameList" :key="index">
                        ...
                        <td class="text-nowrap text-center">{{ parseInt(selectedInvoice.countList[index]).toLocaleString()}} {{selectedInvoice.productUnitList[index]}}</td>
                        <td class="text-nowrap text-end">{{ parseInt(selectedInvoice.sellPriceList[index]).toLocaleString() }} Ks</td>
                      ...
                      <tr class="table-bottom">
                        ...
                        <td class="text-end ">{{parseInt(selectedInvoice.totalPrice).toLocaleString()}} Ks</td>
                      </tr>
                      <tr class="table-bottom" v-if="shopInfo.tax!=='0'" >
                        <td colspan="3" class="text-end text-nowrap">Tax :</td>
                        <td class="text-end">{{selectedInvoice.tax.toLocaleString()}} Ks</td>
                      </tr>
